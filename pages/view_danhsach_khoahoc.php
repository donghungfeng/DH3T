  ...
  <div class="wrap">
    ...
    <div class="main-container">
      <nav class="dhf-sidebar dhf-bar-block  dhf-medium left-menu dhf-animate-left">
        ...
        <!-- <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_khoahoc.php?action=khoahoc_danhsach.php"><span>Danh sách các khóa học<span></a>
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_khoahoc.php?action=khoahoc_dslop.php"><span>Danh sách lớp của khóa học</span></a> -->
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_khoahoc.php?action=khoahoc_dsmon.php"><span>Danh sách bộ môn</span></a>
         <!--  <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_khoahoc.php?action=khoahoc_themkhoahoc.php"><span>Thêm khóa học</span></a> -->
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_khoahoc.php?action=bomon_thembomon.php"><span>Thêm bộ môn</span></a>
        </nav>
