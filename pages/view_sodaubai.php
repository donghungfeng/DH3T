...
<body>
    ...
    <div class="main-container">
        <nav class="dhf-sidebar dhf-bar-block  dhf-medium left-menu dhf-animate-left">
          ...
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_giaovien.php?action=giaovien_dsgv.php"><span>Danh sách giáo viên<span></a>
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_giaovien.php?action=giaovien_dsnhom.php"><span>Danh sách nhóm giáo viên</span></a>
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_giaovien.php?action=giaovien_lich.php"><span>Lịch giảng dạy</span></a>
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_giaovien.php?action=giaovien_themgv.php"><span>Thêm giáo viên</span></a>
        </nav>
