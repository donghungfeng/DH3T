...
<body align="left" width="100%">
    ...
    <div class="main-container">
        <nav class="dhf-sidebar dhf-bar-block  dhf-medium left-menu dhf-animate-left">
          ...
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="viewdanhsach.php?action=lop_dslop.php"><span>Danh sách các lớp học<span></a>
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="viewdanhsach.php?action=lop_dstkb.php"><span>Thời khóa biểu các lớp</span></a>
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="viewdanhsach.php?action=lop_themlop.php"><span>Thêm lớp học</span></a>
          <!-- <a class="dhf-bar-item dhf-button dhf-hover-blue" href="viewdanhsach.php?action=lop_phancong.php"><span>Phân công cho lớp học</span></a> -->
        </nav>
