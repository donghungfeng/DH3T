...
<body>
    ...
    <div class="main-container">
        <nav class="dhf-sidebar dhf-bar-block  dhf-medium left-menu dhf-animate-left">
          ...
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_kiphoc.php?action=kiphoc_dskip.php"><span>Danh sách các kíp học<span></a>
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_kiphoc.php?action=kiphoc_dslop.php"><span>Danh sách các lớp học kíp</span></a>
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_kiphoc.php?action=kiphoc_themkip.php"><span>Thêm kíp học</span></a>
        </nav>
