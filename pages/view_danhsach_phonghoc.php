...
<body>
    ...
    <div class="main-container">
        <nav class="dhf-sidebar dhf-bar-block  dhf-medium left-menu dhf-animate-left">
          ...
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_phonghoc.php?action=phong_dsphong.php"><span>Danh sách phòng học<span></a>
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_phonghoc.php?action=phong_dsphongtrong.php"><span>Danh sách phòng trống</span></a>
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_phonghoc.php?action=phong_lichhd.php"><span>Thời gian hoạt động</span></a>
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_phonghoc.php?action=phong_themphong.php"><span>Thêm phòng học</span></a>
        </nav>
