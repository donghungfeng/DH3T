...
<body>
    ...
    <div class="main-container">
        <nav class="dhf-sidebar dhf-bar-block  dhf-medium left-menu dhf-animate-left">
          ...
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_bomon.php?action=bomon_dsbomon.php"><span>Danh sách các bộ môn<span></a>
          <a class="dhf-bar-item dhf-button dhf-hover-blue" href="view_danhsach_bomon.php?action=bomon_thembomon.php"><span>Thêm bộ môn</span></a>
        </nav>
